 ...
 */
angular.module('cardApp').controller('ninewareCtrl', ['$scope', '$state', '$location', 'dataService', '$rootScope', '$http', 'userinfo',
	function($scope, $state, $location, dataService, $rootScope, $http, userinfo) {
	    console.log('ninewareCtrl');
		...
		$scope.gotoProduct = function(){
			...
			var enStr = {};
			enStr.id = $scope.id;
			enStr.comId = $scope.com_id;
			var encrypId = b.encode(JSON.stringify(enStr));
			var tempUrl = '/nineware/product/'+encrypId;
